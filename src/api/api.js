...
/**********************************************************************/
// 获取配置列表
export const getConfigList = (keyword = '', page = FIRST_PAGE, pageSize = PAGE_SIZE) => {
...
/**********************************************************************/
// 电子审批列表
export const getApprovalList = (keyword = '', page = FIRST_PAGE, pageSize = PAGE_SIZE) => {
...
/**********************************************************************/
//招投标-->发包列表
export const getContractAwardList = (keyword = '', page = FIRST_PAGE, pageSize = PAGE_SIZE) => {
...
//招投标--> 查询权限人员列表
export const getBidUserList = (keyword = '', page = FIRST_PAGE, pageSize = PAGE_SIZE) => {
...
//招投标--> 修改单个人员的权限
export const setBidUserPermission = params => {
    return request('system.admin.setBidUser', 'post', params);
}